      ...
      <div ref={containerRef} className="flex-1 w-full min-h-0 my-2 no-scrollbar z-10 flex flex-col justify-center items-center overflow-y-auto">
        {viewMode === "deck" ? (
          ...
          <div className="w-full h-full max-h-[460px] flex items-center justify-center relative">
            ...
            {/* Compact Center Card Stack */}
            <div className="relative w-[390px] lg:w-[410px] h-[415px] lg:h-[430px] flex items-center justify-center">
              <AnimatePresence mode="popLayout">
                ...
                {/* Active Front Card (Tight Gap, Enlarged Text, Zero Blank Space) */}
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-[2.25rem] border-3 border-ink p-6 lg:p-7 flex flex-col justify-start gap-2.5 lg:gap-3 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] cursor-pointer active:scale-[0.99] transition-transform duration-100 ${currentCard.bgClass}`}
                >
                  {/* Top Bar inside Card */}
                  ...
                  {/* Content pulled UP directly below Graphic (Zero Gap) */}
                  <div className="shrink-0">
                    <h3 className="text-3xl lg:text-4xl font-black text-ink leading-tight tracking-tight">
                      {currentCard.title}
                    </h3>
                    <p className="text-base lg:text-lg text-ink/80 font-normal mt-1.5 leading-relaxed">
              ...
              {DECK_CARDS.map((card) => {
                ...
                return (
                  <Link
                    ...
                    className={`rounded-[2rem] border-3 border-ink p-6 flex flex-col justify-start gap-3 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all cursor-pointer min-h-[350px] ${card.bgClass}`}
                  >
                    ...
                    <div>
                      <h3 className="text-2xl md:text-3xl font-black text-ink leading-tight tracking-tight">{card.title}</h3>
                      <p className="text-base text-ink/80 font-normal mt-1.5 leading-relaxed">
                        {card.description}
                      </p>
                    </div>
