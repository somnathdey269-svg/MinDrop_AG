      ...
      <div ref={containerRef} className="flex-1 w-full min-h-0 my-1 z-10 flex flex-col justify-center items-center overflow-hidden">
        {viewMode === "deck" ? (
          ...
          <div className="w-full h-full flex items-center justify-center relative">
            ...
            {/* Web Card Container (Commanding Hero Proportions) */}
            <div className="relative w-[clamp(420px,34vw,560px)] h-[clamp(580px,75vh,720px)] flex items-center justify-center">
              <AnimatePresence mode="popLayout">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 rounded-[2.8rem] border-3 lg:border-4 border-ink p-7 lg:p-9 flex flex-col justify-between bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] pointer-events-none"
                >
                ...
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-[2.8rem] border-3 lg:border-4 border-ink p-7 lg:p-9 flex flex-col justify-between shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] cursor-pointer active:scale-[0.99] transition-transform duration-100 ${currentCard.bgClass}`}
                >
                  {/* Section 1: Header Tag Pill */}
                  <div className="shrink-0 flex justify-between items-center h-8">
                    <span className="text-xs lg:text-sm font-black uppercase tracking-wider text-ink bg-white/95 border-2 border-ink/20 px-4.5 py-1.5 rounded-full shadow-sm">
                      {currentCard.tag}
                    </span>
                  </div>
                  ...
                  <div className="shrink-0 mt-3">
                    ...
                    <p className="text-base lg:text-lg text-ink/80 font-medium leading-relaxed line-clamp-3">
