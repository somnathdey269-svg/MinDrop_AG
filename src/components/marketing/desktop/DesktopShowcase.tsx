      ...
      <div ref={containerRef} className="flex-1 w-full min-h-0 my-1 z-10 flex flex-col justify-center items-center overflow-hidden">
        {viewMode === "deck" ? (
          ...
          <div className="w-full h-full flex items-center justify-center relative">
            ...
            {/* Web Card Container (Balanced Proportions) */}
            <div className="relative w-[clamp(360px,28vw,440px)] h-[clamp(450px,58vh,520px)] flex items-center justify-center">
              <AnimatePresence mode="popLayout">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 rounded-[2.2rem] border-3 border-ink p-6 lg:p-7 flex flex-col justify-between bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] pointer-events-none"
                >
                ...
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-[2.2rem] border-3 border-ink p-6 lg:p-7 flex flex-col justify-between shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] cursor-pointer active:scale-[0.99] transition-transform duration-100 ${currentCard.bgClass}`}
                >
                  ...
                  <div className="shrink-0 mt-2">
                    <h3 className="text-2xl lg:text-3xl font-black text-ink leading-tight tracking-tight mb-1.5 whitespace-nowrap overflow-hidden text-ellipsis">
                      {currentCard.title}
                    </h3>
                    <p className="text-sm lg:text-base text-ink/80 font-medium leading-relaxed line-clamp-3">
