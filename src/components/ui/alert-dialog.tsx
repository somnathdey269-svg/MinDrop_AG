  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "inset-x-0 bottom-0 top-auto max-w-none rounded-t-2xl rounded-b-none pb-6",
        /* desktop: centered modal */
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg",
        className,
      )}
      {...props}
    />
