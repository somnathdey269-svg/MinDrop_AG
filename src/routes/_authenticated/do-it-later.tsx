...
export const Route = createFileRoute("/_authenticated/do-it-later")({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: SITE + "/do-it-later" },
        ...(ogImage ? [{ property: "og:image", content: ogImage }, { name: "twitter:image", content: ogImage }] : []),
      ],
      links: [{ rel: "canonical", href: SITE + "/do-it-later" }],
    };
  },
  component: () => (
    <StoryLayout>
