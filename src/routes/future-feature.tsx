    ...
    >
      ...
      <header className="shrink-0 h-12 border-b-2 border-ink/10 z-50 px-4 sm:px-6 flex items-center justify-center sm:justify-between backdrop-blur-md"
        ...
        <Link to="/" hash={backHash} viewTransition
          className={`hidden sm:flex items-center gap-1 text-[11px] sm:text-xs font-black uppercase tracking-wider shrink-0 transition ${isDark ? "text-[#60A5FA] hover:text-white" : "text-ink/70 hover:text-ink"}`}>
