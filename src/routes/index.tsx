      ...
      >
        ...
        {viewMode === "deck" ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center relative">
            ...
            <div className="relative w-[280px] sm:w-[320px] md:w-[480px] lg:w-[520px] h-[330px] sm:h-[370px] md:h-[520px] lg:h-[560px] flex items-center justify-center z-10">
              <AnimatePresence mode="popLayout">
                ...
                >
                  <div className="shrink-0">
                    ...
                    <p className="text-[10px] sm:text-sm text-ink/80 font-bold mt-2 sm:mt-4 leading-relaxed">
