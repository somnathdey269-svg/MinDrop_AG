...
import { AlarmClock, Check, X, ArrowRight, Bell, Play, ShieldAlert, Sparkles } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 items-start md:items-center mt-4">
            ...
            >
              <motion.div
                ...
                className="size-36 md:size-48 bg-[#E2F5EC] border-3 border-ink rounded-[2rem] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] grid place-items-center relative"
              >
                <AlarmClock className="size-16 md:size-22 text-ink stroke-[2.5px]" />
              </motion.div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-4 items-center">
              ...
              <div className="border-2 border-ink bg-white p-4.5 rounded-2xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center">
                <span className="text-[10px] font-black text-[#10B981] uppercase tracking-wider">01 / Trigger</span>
                <h4 className="text-xs sm:text-sm font-black text-ink mt-1.5 leading-snug">Alert Fire</h4>
                <p className="text-[11px] text-ink/60 font-semibold mt-1 leading-normal">Deadline is reached on-device</p>
              </div>
              ...
              {/* Step 2 */}
              <div className="border-2 border-ink bg-white p-4.5 rounded-2xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center">
                <span className="text-[10px] font-black text-[#10B981] uppercase tracking-wider">02 / Loop</span>
                <h4 className="text-xs sm:text-sm font-black text-ink mt-1.5 leading-snug">Ringer Loop</h4>
                <p className="text-[11px] text-ink/60 font-semibold mt-1 leading-normal">Ringtone loops continuously like phone call</p>
              </div>
              ...
              <div className="border-2 border-ink bg-white p-4.5 rounded-2xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center">
                ...
                <h4 className="text-xs sm:text-sm font-black text-ink mt-1.5 leading-snug">Boot Guard</h4>
                <p className="text-[11px] text-ink/60 font-semibold mt-1 leading-normal">Sweep reschedules loop on device restart</p>
              </div>
              ...
              <div className="border-2 border-ink bg-white p-4.5 rounded-2xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center">
                ...
                <h4 className="text-xs sm:text-sm font-black text-ink mt-1.5 leading-snug">Snooze / End</h4>
                <p className="text-[11px] text-ink/60 font-semibold mt-1 leading-normal">Requires manual check-off to silence</p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-sm font-bold text-ink/80 leading-relaxed">
                Ordinary push notifications get easily lost in busy dashboards or accidentally swiped away. Passive reminders fail to capture urgent attention, leading to missed tasks, forgotten routines, and overall friction.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm font-bold text-ink/80 leading-relaxed">
                MinDrop hooks directly into native system hardware schedulers. When a drop fires, it launches a foreground service playing looping audio streams. The boot sweep daemon monitors reboots to preserve alarms.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm font-bold text-ink/80 leading-relaxed">
                It guarantees immediate action. Important notifications loop persistently like an incoming phone call, keeping your focus locked until you manually snooze or dismiss the sweep list checklist.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3.5">
                <li className="flex items-start gap-3 text-xs sm:text-sm font-bold text-ink">
                  <Check className="size-5 text-[#10B981] shrink-0 stroke-[3.5px] mt-0.5" />
                  <span>Voice memo capture & photo attachment attachments</span>
                </li>
                <li className="flex items-start gap-3 text-xs sm:text-sm font-bold text-ink">
                  <Check className="size-5 text-[#10B981] shrink-0 stroke-[3.5px] mt-0.5" />
                  <span>Boot auto-recovery background sweeps daemon</span>
                </li>
                <li className="flex items-start gap-3 text-xs sm:text-sm font-bold text-ink">
                  <Check className="size-5 text-[#10B981] shrink-0 stroke-[3.5px] mt-0.5" />
                  <span>Interactive Snooze intervals picker (5m to 2h)</span>
                </li>
                <li className="flex items-start gap-3 text-xs sm:text-sm font-bold text-ink">
                  <Check className="size-5 text-[#10B981] shrink-0 stroke-[3.5px] mt-0.5" />
                  <span>Strict persistent ringers bypassing DND modes</span>
                </li>
              </ul>
            </motion.div>
          </div>
