...
function LaterFeatureDetailView() {
  ...
  return (
    ...
    >
      ...
      <header className="shrink-0 h-12 border-b-2 border-[#10B981]/10 z-50 px-4 sm:px-6 flex items-center justify-center sm:justify-between backdrop-blur-md"
        style={{ backgroundColor: isDark ? "rgba(6,78,59,0.96)" : "rgba(226,245,236,0.96)", transition: "background-color 0.4s ease" }}>
        <Link to="/" hash={backHash} viewTransition
          className={`hidden sm:flex items-center gap-1 text-xs font-black uppercase tracking-wider shrink-0 transition ${isDark ? "text-[#A7F3D0]/70 hover:text-white" : "text-[#047857]/70 hover:text-[#064E3B]"}`}>
