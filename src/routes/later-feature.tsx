        ...
        >
          ...
          <div className="md:col-span-7 text-left">
            ...
            <ul className="mt-8 space-y-3.5 border-t-2 border-dashed border-ink/10 pt-6">
              <li className="flex items-start gap-3 text-xs md:text-sm font-bold text-ink">
                <Check className="size-5 text-[#10B981] shrink-0 mt-0.5 stroke-[3px]" />
          ...
          <div className="md:col-span-5 flex justify-center items-center">
            <motion.div
              ...
              className="size-48 md:size-60 bg-[#E2F5EC] border-3 border-ink rounded-[2rem] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] grid place-items-center relative"
            >
              <AlarmClock className="size-20 md:size-24 text-ink stroke-[2.5px]" />
            </motion.div>
          </div>
        </motion.div>
      </main>
