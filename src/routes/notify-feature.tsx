        ...
        >
          ...
          <div className="md:col-span-8 text-left pr-2">
            ...
            <ul className="mt-8 space-y-4 border-t-2 border-dashed border-ink/10 pt-6">
              <li className="flex items-start gap-3.5 text-xs sm:text-sm md:text-base font-bold text-ink">
                <Check className="size-5.5 text-[#F59E0B] shrink-0 mt-0.5 stroke-[3px]" />
          ...
          <div className="md:col-span-4 flex justify-center items-center">
            <motion.div
              ...
              className="size-48 md:size-64 bg-[#FFFBEB] border-3 border-ink rounded-[2rem] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] grid place-items-center relative"
            >
