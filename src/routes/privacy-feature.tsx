...
function PrivacyFeatureDetailView() {
  ...
  return (
    ...
    >
      ...
      <header className="shrink-0 h-12 border-b-2 border-[#059669]/10 z-50 px-4 sm:px-6 flex items-center backdrop-blur-md"
        ...
        <div className="w-full max-w-7xl mx-auto flex items-center justify-between gap-2 h-full">
          <Link to="/" hash={backHash} viewTransition
            className={`flex items-center gap-1 text-[11px] sm:text-xs font-black uppercase tracking-wider shrink-0 transition ${isDark ? "text-[#A7F3D0]/70 hover:text-white" : "text-[#059669]/70 hover:text-[#064E3B]"}`}>
          ...
          <Link to="/download" viewTransition
            className={`inline-flex items-center justify-center h-[20px] sm:h-[22px] text-[9px] sm:text-[10px] font-extrabold uppercase tracking-widest px-2.5 sm:px-3 rounded-full border shrink-0 leading-none shadow-xs transition ${isDark ? "bg-white text-ink border-white hover:bg-[#059669] hover:text-white hover:border-[#059669]" : "bg-[#059669] text-white border-[#059669] hover:bg-ink hover:border-ink"}`}>
            Get App
          </Link>
        </div>
      </header>
